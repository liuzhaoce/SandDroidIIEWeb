...
class ApkInfoHandler(BaseHandler):
    ...
    def to_json(self, apks):
        ...
        for apk in apks:
            ...
            # added by songalee at 201705725
            result.append(apk.check_time)
    ...
    def process_table(self, session_query, column_header):
        ...
        session_query = session_query.order_by(APK.id.desc())
...
class ReportInfoHandler(BaseHandler):
    ...
    def process_alias(self):
        ...
        results_json = self.results_json
        try:
            results_json['antivir'] = apk.virustotal.AntiyAVL
        except:
            results_json['antivir'] = ''
        try:
            results_json['avg'] = apk.virustotal.AVG
        except:
            results_json['avg'] = ''
        try:
            results_json['kaspersky'] = apk.virustotal.Kaspersky
        except:
            results_json['kaspersky'] = ''
        try:
            results_json['nod32'] = apk.virustotal.ESETNOD32
        except:
            results_json['nod32'] = ''
        try:
            results_json['symantec'] = apk.virustotal.Symantec
        except:
            results_json['symantec'] = ''
    ...
    def process_riskscore_chart(self):
        ...
        while cur_score < 100:
            ...
            if cur_score == 80:
                ...
                riskscore_json.append(
                    ['%s-%s' % (cur_score, cur_score + step), float('%.2f' % (count / total_count * 100))])
            cur_score += step
...
class MobileQueryHandler(ApkInfoHandler):
    ...
    def to_json(self, apks):
        ...
        for apk in apks:
            ...
            try:
                result['kaspersky'] = apk.virustotal.Kaspersky
            except:
                result['kaspersky'] = ''
            try:
                result['antivir'] = apk.virustotal.AntiyAVL
            except:
                result['antivir'] = ''
            try:
                result['nod32'] = apk.virustotal.ESETNOD32
            except:
                result['nod32'] = ''
